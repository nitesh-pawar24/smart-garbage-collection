...
export default function ReportGenerationAnalytics() {
  ...
  const reports = [
    ...
    { id: 2, title: 'Feedback and Grievance Resolution Times', description: 'Analyze feedback handling and resolution timelines', icon: BarChart3, color: 'bg-green-50 dark:bg-green-900/20', iconColor: 'text-green-600 dark:text-green-400', borderColor: 'border-green-100 dark:border-green-800/50' },
